...
if __name__ == "__main__":
    ...
    subnetwork_mask = LargestVarianceDiagLaplaceSubnetMask(model, int(args.subnetwork_size), la_diag)
    ...
    for i in range(125):
        ...
        log_marginal_likelihood_sweep[i] = la.log_marginal_likelihood().detach().cpu().numpy()
    ...
    fname = f"/home/user/subset_laplace/subnetwork_{args.subnetwork_size}_s{args.seed}_val"
