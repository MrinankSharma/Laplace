...
if __name__ == "__main__":
    ...
    np_y = np.load(f"/data/stat-oxcsml/magd5198/data/CIFAR-10-C/labels.npy").astype(
        np.int64
    )
    for c in corruptions:
        data_file = f"/data/stat-oxcsml/magd5198/data/CIFAR-10-C/{c}.npy"
    ...
    pickle.dump(
        all_res_dict,
        open(f"/data/stat-oxcsml/magd5198/subset_laplace/{args.stochastic_groups_str}_s{args.seed}.pkl", "wb")
    )
